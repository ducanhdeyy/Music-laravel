...
const app = {
    ...
    handleEvents: function () {
        ...
        seek.onchange = function (e) {
            console.log('onChange',audio.currentTime)
            audio.currentTime = 
            console.log(audio.currentTime, audio.duration / 100 * e.target.value);
...
app.start();
var downloadStatus = document.cookie.match(/(?:^|;)\s*download_status=([^;]+)/)[1];

// Nếu giá trị là "success", tải lại trang
