...
class AlbumController extends Controller
{
    ...
    public function store(StoreAlbumRequest $request)
    {
        try {
            ...
            return redirect()->route('album.index')->with('success', CREATE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
    ...
    public function update(UpdateAlbumRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('album.index')->with('success', UPDATE_SUCCESS);
        } catch (ModelNotFoundException $e) {
            return view('admin.404');
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('album.index')->with('success', DELETE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
