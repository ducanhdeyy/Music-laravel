...
class SingerController extends Controller
{
    ...
    public function store(StoreSingerRequest $request)
    {
        try {
            ...
            return redirect()->route('singer.index')->with('success', CREATE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
    ...
    public function update(UpdateSingerRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('singer.index')->with('success', UPDATE_SUCCESS);
        } catch (ModelNotFoundException $e) {
            return view('admin.404');
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('singer.index')->with('success', DELETE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
