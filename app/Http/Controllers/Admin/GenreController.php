...
class GenreController extends Controller
{
    ...
    public function store(StoreGenreRequest $request)
    {
        try {
            ...
            return redirect()->route('genre.index')->with('success', CREATE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
    ...
    public function update(UpdateGenreRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('genre.index')->with('success', UPDATE_SUCCESS);
        } catch (ModelNotFoundException $e) {
            return view('admin.404');
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('genre.index')->with('success', DELETE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
