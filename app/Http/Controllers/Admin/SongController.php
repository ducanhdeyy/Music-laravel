...
class SongController extends Controller
{
    ...
    public function __construct(SongService $songService, SingerService $singerService, AlbumService $albumService, GenreService $genreService)
    {
    ...
    public function store(StoreSongRequest $request)
    {
        try {
            ...
            return redirect()->route('song.index')->with('success', CREATE_SUCCESS);
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
    ...
    public function update(UpdateSongRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('song.index')->with('success', UPDATE_SUCCESS);
        } catch (ModelNotFoundException $e) {
            return view('admin.404');
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
