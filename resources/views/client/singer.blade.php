                                ...
                                <div class="row list-row">
                                    ...
                                    <div class="col-6 col-sm-4" data-id="312058991" data-category="all" data-tag="France" data-source="https://audio-ssl.itunes.apple.com/apple-assets-us-std-000001/AudioPreview62/v4/04/b6/28/04b62834-121f-b3af-47b3-2485ff499e14/mzaf_4474193750897158038.plus.aac.p.m4a">
                                        <div class="list-item r">
                                            <div class="media col-4"><a href="" class="ajax media-content" style="background-image:url(<?php echo 'uploads/' . $song['image'] ?>)" data-pjax-state=""></a>
                                            ...
                                            <div class="list-content text-center">
                                                <div class="list-body">
                                                    <a href="" class="list-title title ajax h-1x" data-pjax-state=""><?php echo $song['name'] ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="w-xl w-auto-sm no-shrink">
                        <div class="padding sticky">
                            ...
                            <div class="row list-row">
                                ...
                                <div class="col-12" data-id="274510331" data-category="Pop" data-tag="all" data-source="<?php echo 'uploads/' . $topTrack['file_url'] ?>">
                                    <div class="list-item r">
                                        <div class="media"><a href="" class="ajax media-content" style="background-image:url(<?php echo 'uploads/' . $topTrack['image'] ?>)" data-pjax-state=""></a>
                                            <div class="media-action">
                                                ...
                                                <div data-index="<?php echo $i; $i++; ?>" class="playpause-track1" data-url="<?php echo  'uploads/' . $topTrack['file_url'] ?>" data-name="<?php echo $topTrack['name'] ?>" data-image="<?php echo  'uploads/' . $topTrack['image'] ?>"><i class="fa fa-play-circle fa-3x"></i></div>
                                                <button class="btn btn-icon no-bg no-shadow hide-row btn-more" data-toggle="dropdown">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal">
                                                        <circle cx="12" cy="12" r="1"></circle>
                                                        <circle cx="19" cy="12" r="1"></circle>
                                        ...
                                        <div class="list-content">
                                            <div class="list-body"><a href="" class="list-title title ajax h-1x" data-pjax-state=""><?php echo  $topTrack['name'] ?></a><a href="" class="list-subtitle d-block text-muted subtitle ajax h-1x" data-pjax-state=""><?php echo  $topTrack['name_singer'] ?></a></div>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
